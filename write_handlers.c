...
int write_unsgnd(int is_negative, int ind,
	...
	int flags, int width, int precision, int size)
{
	/* The number is usually stored at the buffer's right and starts at position i */
	...
	if (width > length)
	{
		...
		if (flags & F_MINUS) /* Asign extra char to the left of the buffer [buffer>padd]*/
		{
...
/**
 * write_pointer - Write a memories address
